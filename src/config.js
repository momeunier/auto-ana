export const DEFAULT_PROMPT = `## Objective
...
## Instructions
Watch the following videos and extract the ad script modules.
...
Include the description of each of the criterias used in the evaluation.
Give me recommendations for iterations so that you would give a 10/10 score for all modules that you consider
Tell me what will likely not perform
What should I be avoiding next time

Consider sending a version of this report to a brand strategist or art director. What would say to help improve the creatives on the next round of iteration?
If a CSV file is uploaded, use the data found in the file to inform all your recommendations. The data is the most important starting point.
Always use CTR, CVR and other metrics in your answer to support your recommendations.
`;
